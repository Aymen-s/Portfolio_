...
const projects = [
  {
    ...
    TechStack: ["ReactJS", "Tailwind CSS", "Vite"],
  },
  {
    id: "2",
    Img: "project2.jpg",
    Title: "Task Manager App",
    Description: "A productivity app to manage tasks with Firebase backend.",
    Link: "https://example.com/project2",
    TechStack: ["ReactJS", "Firebase", "Material UI"],
  },
  {
    id: "3",
    Img: "project3.jpg",
  ...
  },
  {
    ...
    Img: "project4.jpg",
    Title: "Blog Platform",
    Description: "A blog site with dynamic content and responsive design.",
    Link: "https://example.com/project4",
    TechStack: ["ReactJS", "Node JS", "Bootstrap"],
  },
  {
    id: "5",
    Img: "project5.jpg",
    Title: "Weather App",
    Description: "A weather forecasting app with real-time API integration.",
    Link: "https://example.com/project5",
    TechStack: ["JavaScript", "ReactJS", "Vite"],
  },
  {
    id: "6",
    Img: "project6.jpg",
  ...
  },
  {
    ...
    Img: "project7.jpg",
    Title: "Event Planner",
    Description: "An app to organize and manage events efficiently.",
